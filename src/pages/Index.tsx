        ...
        <div className="max-w-4xl mx-auto rounded-2xl bg-secondary px-5 sm:px-10 py-10 sm:py-12 overflow-hidden">
          ...
          <div className="relative w-full overflow-x-auto">
            ...
            >
              ...
              {/* ===== TRADITIONAL DIAMOND (top, muted) ===== */}
              <text x="12" y="105" className="fill-secondary-foreground/30" fontSize="10" fontFamily="DM Sans" fontWeight="500">Traditional</text>

              {/* Diamond 1 - Traditional */}
              <polygon
                points="0,105 225,55 225,155 0,105"
                fill="hsl(215 20% 65% / 0.08)"
                stroke="hsl(215 20% 65% / 0.25)"
                strokeWidth="1.5"
              />
              <polygon
                points="225,55 450,105 450,105 225,155"
                fill="hsl(215 20% 65% / 0.08)"
                stroke="hsl(215 20% 65% / 0.25)"
                strokeWidth="1.5"
              />

              {/* Diamond 2 - Traditional */}
              <polygon
                points="450,105 675,55 675,155 450,105"
                fill="hsl(215 20% 65% / 0.08)"
                stroke="hsl(215 20% 65% / 0.25)"
                strokeWidth="1.5"
              />
              <polygon
                points="675,55 900,105 900,105 675,155"
                fill="hsl(215 20% 65% / 0.08)"
                stroke="hsl(215 20% 65% / 0.25)"
                strokeWidth="1.5"
              />
              ...
              {/* ===== AI-ENHANCED DIAMOND (bottom, vibrant) ===== */}
              <text x="12" y="280" className="fill-primary" fontSize="10" fontFamily="DM Sans" fontWeight="500">AI-Enhanced</text>

              {/* Diamond 1 - AI */}
              <polygon
                points="0,280 225,220 225,340 0,280"
                fill="hsl(200 98% 39% / 0.12)"
                stroke="hsl(200 98% 39% / 0.5)"
                strokeWidth="2"
              />
              <polygon
                points="225,220 450,280 450,280 225,340"
                fill="hsl(200 98% 39% / 0.12)"
                stroke="hsl(200 98% 39% / 0.5)"
                strokeWidth="2"
              />
              ...
              {/* Diamond 2 - AI */}
              <polygon
                points="450,280 675,220 675,340 450,280"
                fill="hsl(28 60% 55% / 0.12)"
                stroke="hsl(28 60% 55% / 0.5)"
                strokeWidth="2"
              />
              <polygon
                points="675,220 900,280 900,280 675,340"
                fill="hsl(28 60% 55% / 0.12)"
                stroke="hsl(28 60% 55% / 0.5)"
                strokeWidth="2"
              />
              ...
              {/* Connecting lines from diamonds to labels */}
